...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Lampu Baru</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form action="{{ route('admin.lampus.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <button type="submit" class="btn btn-primary mt-3">Simpan Data Lampu</button>
                <a href="{{ route('admin.lampus.index') }}" class="btn btn-secondary mt-3">Batal</a>
